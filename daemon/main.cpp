...
static bool should_drop_privileges() {
    ...
    bool ro_debuggable = ANDROID_DEBUGGABLE ? 1 : __android_log_is_debuggable();
...
static void drop_privileges() {
    ...
    if (should_drop_privileges()) {
        const bool should_drop_caps = !(ANDROID_DEBUGGABLE ? 1 : __android_log_is_debuggable());
...
int adbd_main() {
    ...
    if (device_unlocked || (ANDROID_DEBUGGABLE ? 1 : __android_log_is_debuggable())) {
